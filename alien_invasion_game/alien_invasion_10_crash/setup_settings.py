...
class SettingsManager:
    ...
    def _create_scroll_bars(self):
        ...
        scroll_bars = {
            ...
            'bullet_speed': self._create_scroll_bar(700, 340, self.settings.bullet_speed, 1.0, 5.0),
            'enemy_speed': self._create_scroll_bar(700, 370, self.settings.enemy_speed, 0.5, 5.0),
            'enemy_bullet_speed': self._create_scroll_bar(700, 400, self.settings.enemy_bullet_speed, 1.0, 5.0),
            'difficulty_level': self._create_scroll_bar(700, 430, 1, 1, 10)  # Start at difficulty level 1
        }
        return scroll_bars
    ...
    def draw_scroll_bars(self, screen):
        ...
        for key, bar in self.scroll_bars.items():
            ...
            value_surface = self.font.render(str(int(bar['value'])), True, (0, 0, 0))
    ...
    def apply_settings(self):
        ...
        self.settings.enemy_bullet_interval = 500 + int((10 - self.scroll_bars['difficulty_level']['value']) * 250)  # Scale difficulty
